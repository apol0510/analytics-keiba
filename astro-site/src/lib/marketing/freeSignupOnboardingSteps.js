...
export const FREE_SIGNUP_ONBOARDING_STEPS = Object.freeze([
  ...
  step({
    ...
    // ⚠️ 2026-09-15 本番の実ページで用語を突き合わせた結果、`docs/spec.md` の語彙と
    //    画面の表示ラベルがずれていたので、**画面の言い方**に合わせた:
    //      厩舎 → **調教師** / 過去走 → **近走**（「近走詳細データ」）
    //    また `枠` は per-horse の表示が無く、`通算成績` は画面に出ていないため**書かない**
    //    （受信者がページで探しても見つからない語を約束しない）。
