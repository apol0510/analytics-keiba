...
export const FREE_SIGNUP_ONBOARDING_STEPS = Object.freeze([
  ...
  step({
    ...
    name: '予想ページの見方',
    subject: '【KEIBA Analytics】予想ページの見方（どの馬から見ればよいか）',
    preheader: '出走する全頭に役割が付いています。見る順番だけ決まれば迷いません。',
    badge: '使い方',
    headline: '予想ページは「役割」から見てください',
    body: [
      'ご登録ありがとうございます。無料予想の見方をご案内します。',
      '',
      '予想ページでは、出走する全頭を AI 指数で分類しています。',
      '本命◎・対抗○・単穴▲・連下・抑え、そして買い目に入らない不要馬まで、',
      'どの馬も必ずどれかに分類されます。',
      '',
      '最初にご覧いただきたいのは本命◎と対抗○の 2 頭です。',
      'この 2 頭がその日の軸で、買い目もここを起点に組み立てています。',
      '',
      '本日のレースでそのまま確かめていただけます。',
    ],
    benefitTitle: '無料でご覧いただけるもの',
    benefitItems: [
      '全頭の役割（本命・対抗・単穴・連下・抑え・不要馬）',
      'AI 総合指数',
      'メインレースの買い目',
    ],
    ctaLabel: '今日の予想で役割の並びを見る',
    ctaUrl: `${SITE}/free-prediction/nankan/`,
  ...
  step({
    ...
    preheader: '点数を増やして当たりやすくする、という作りにはしていません。',
    badge: '買い目',
    ...
    body: [
      ...
      '',
      '本日のメインレースで、実際の買い目をご確認いただけます。',
    ],
    benefitTitle: '買い目について',
    benefitItems: [
      'メインレースは最大5点',
      '本命を軸にした一方向の馬単',
      '全プラン共通の点数',
    ],
    ctaLabel: '今日のメインレースの買い目を見る',
    ctaUrl: `${SITE}/free-prediction/nankan/`,
    ctaNote: 'ログインは不要です。そのままご覧いただけます。',
  }),
