...
export const DISCOUNT_FREE_STEPS = Object.freeze([
  step({
    ...
    body: [
      ...
      '',
      'ご登録いただいている皆さまを対象に、有料プランの割引をご案内します。',
  ...
  step({
    ...
    body: [
      ...
      '',
      '前日のメインレース買い目とその結果は、当たった日も外した日も',
      'そのまま無料で公開しています。実際の中身をご覧いただいたうえで',
      'ご検討いただければ幸いです。',
      '',
...
export const DISCOUNT_LIGHT_STEPS = Object.freeze([
  step({
    ...
    body: [
      ...
      '',
      'ご登録いただいている皆さまを対象に、Premium の割引をご案内しています。',
      '',
...
export const DISCOUNT_PREMIUM_STEPS = Object.freeze([
  step({
    ...
    body: [
      ...
      '',
      'Premium をご利用中の方を対象に、三連複予想（買い切り）の割引をご案内しています。',
      '',
