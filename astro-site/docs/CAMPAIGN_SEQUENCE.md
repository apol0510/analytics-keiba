...
MARKETING_ADMIN_SECRET=… npm run preflight:light-trial-step1 -- --expect 10
```
...
**検算するだけ**。作り直すと画面の人数と preflight の人数がズレる（2026-08-13 の 4,000 件
打ち切り事故と同じ構図）。
...
| `step1Preflight.test.mjs` | Step1 直前確認の判定（**確認できないものを ok にしない**） |
